...
type CallExpression struct {
        ...
        // Identifier or FunctionLiteral Arguments []Expression
        }
...
type FunctionLiteral struct {
    Token token.Token 
    Parameters []*Identifier// The 'fn' token Parameters []*Identifier
    Body *BlockStatement
    }
...
func (ie *IfExpression) TokenLiteral() string { return ie.Token.Literal } func (ie *IfExpression) String() string {
var out bytes.Buffer out.WriteString("if")
...
func (fl *FunctionLiteral) TokenLiteral() string { return fl.Token.Literal } f
...
out.WriteString(") ") out.WriteString(fl.Body.String())
return out.String()
}
